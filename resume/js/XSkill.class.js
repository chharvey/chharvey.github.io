...
class XSkill extends HTMLElement {
  constructor() {
    ...
    frag.querySelector('[itemprop="bestRating"]' ).setAttribute('content', Skill.LEVELS.length)
    frag.querySelector('[itemprop="ratingValue"]').setAttribute('content', this._level)
