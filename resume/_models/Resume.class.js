...
const AWARDS = [
  ...
  new Award(`<time>2003</time>&ndash;<time>2006</time>`, `
    ...
    <dl class="o-ListAchv">
      ${new Award(`<time>2005</time>&ndash;<time>2006</time>`,`Trombone I &amp; Field Captain`).html()}
      ${new Award(`<time>2003</time>&ndash;<time>2004</time>`,`Trombone II`).html()}
    </dl>
  `),
]
...
const TEAMS = [
  ...
  new Award(`<time>2003</time>&ndash;<time>2006</time>`, `
    <div class="h-Inline" itemscope="" itemtype="http://schema.org/SportsTeam">
      ...
      <dl class="o-ListAchv">
        ${new Award(`<time>2003</time>&ndash;<time>2006</time>`,`Four-year letter achiever`).html()}
        ${new Award(`<time>2004</time>, <time>2006</time>`,`VA State qualifier for 200 Free Relay`).html()}
      </dl>
    </div>
  `),
  new Award(`<time>1994</time>&ndash;<time>2006</time>`, `
    <div class="h-Inline" itemscope="" itemtype="http://schema.org/SportsTeam">
      ...
      <dl class="o-ListAchv">
        ${new Award(`<time>2005</time>`,`Team record breaker in 200 Free Relay`).html()}
        ${new Award(`<time>2000</time>, <time>2002</time>`,`All-Star competitor in 50 Free`).html()}
      </dl>
    </div>
  `)
]
