...
- 2014-03-06 when list items are complete, *do not* delete the list item. Wrap it with the `<del datetime="">` tag. (Starting as of today; see Git repo history for items deleted before today.)
